                                    ...
                                    <div class="flex-fill d-flex">
                                        <div class="flex-fill">
                                            <div class="d-flex mb-2">
                                                <i class="material-icons icon-16pt mr-1">business</i>
                                                <strong>Deadline</strong>
                                                <div class="text-muted">{{ $completed['deadline']}} </div>
                                                <!-- <span class="text-muted ml-1"><i class="material-icons icon-16pt">email</i> contact@frontted.com</span> -->
                                            </div>

                                            <div class="mb-2">
                                                <a href="/expert/projects/{{ $completed['id']}}"
                                                    class="text-body mr-1"><strong>{{ $completed['project_title']}}</strong></a>
                                            </div>
                                            <div class="">
