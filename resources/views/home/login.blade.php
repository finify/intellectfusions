        ...
        <div class="flex justify-center w-full h-screen items-center">
            <div class="w-full md:w-3/4 lg:w-2/6 ts-gray-2 py-3 rounded-lg shadow">
                ...
                <div class="px-4 lg:px-10 mt-6 space-y-6">
                    <p class="bg-green-500 text-gray-300 p-1 rounded-lg text-xs text-center hidden" id="noticeMsg">
                ...
                <form action="{{ url('user/login')}}" method="POST" class="px-4 lg:px-10 mt-6 space-y-6 " id="loginForm">
                    @csrf
                    <div class="grid grid-cols-1">
                        <div class="relative">
                            ...
                            <input type="text" id="email" name="username" placeholder="Email Or Username" class="theme1-text-input"
                    ...
                    <div class="flex justify-between text-gray-300 text-xs font-semibold mt-4 px-5 lg:px-10">
                        <div>
                            <a href="/user/register/" class="hover:text-purple-700">Don't have account? Register</a>
                        </div>

                        <!-- <div>
                            <a href="forgot-password.html" class="hover:text-purple-700">Forgot Password?</a>
                        </div> -->
                ...
                <!-- <form action="https://crypto-bot.org/login-verify" method="POST"
                    class="px-4 lg:px-10 mt-6 space-y-6  hidden " id="verifyForm">
